...
class CustomDropDownButtonFormField extends StatefulWidget {
 ...
 final void Function(String?)? onSaved;
  ...
  const CustomDropDownButtonFormField({super.key, required this.value, required this.onChanged,required this.onSaved});
    ...
    return DropdownButtonFormField<String>(
      ...
      items: ['Male', 'Female'].map((String value) {
        return DropdownMenuItem<String>(
          value: value,
          child: Text(value, style: TextStyles.medium14.copyWith(color: const Color(0xff242424))),
        );
      }).toList(),
