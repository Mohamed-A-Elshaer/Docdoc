...
class AppointmentModule {
  Future<Map<String, dynamic>> storeAppoint(
      {required int docId, required String start_time, String? notes}) async {
    Map<String, dynamic> response = await Api().post(
      url: '${Environment.apiBaseUrl}appointment/store',
      body: {
  ...
  Future<List<AppointmentModel>> getAppoint() async {
    ...
    return appointsJson.map((json) => AppointmentModel.fromJson(json)).toList();
  }
}
