  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(
          right: ResponsiveDimensions.responsiveWidth(context, 25)),
      child: Center(
        child: Row(
              ...
              onTap: () {
                ...
                if (index > currentPageIndex) {
                  ...
                  if (bookingEntity.dateTimeEntity == null ||
                      bookingEntity.dateTimeEntity?.isAvailableTimeChosen !=
                          true) {
                  ...
                  if (index == 2 &&
                      (bookingEntity.paymentOptionEntity == null ||
                          bookingEntity
                                  .paymentOptionEntity?.isPaymentOptionChosen !=
                              true)) {
...
List<String> getSteps() {
  return ['Date & Time', 'Payment', 'Summary'];
}
