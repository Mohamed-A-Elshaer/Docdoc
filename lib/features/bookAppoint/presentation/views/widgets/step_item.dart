...
final bool hasRightPadding;
  ...
  Widget build(BuildContext context) {
    if (isCompleted) {
      return CompletedStepItem(index: index, text: text, isFirst: isFirst, hasRightPadding: hasRightPadding);
    } else if (isActive) {
      return ActiveStepItem(index: index, text: text, isFirst: isFirst, hasRightPadding: hasRightPadding);
    } else {
      return InActiveStepItem(index: index, text: text, isFirst: isFirst, hasRightPadding: hasRightPadding);
    }
  }
}
