            ...
            children: [
              ...
              Stack(
                ...
                children: [
                  Transform.translate(
                      offset:
                          Offset(MediaQuery.of(context).size.width * -0.12, 0),
                      child: SvgPicture.asset(Assets.imagesAppEmblem)),
                  Transform.translate(
                      offset:
                          Offset(0, MediaQuery.of(context).size.height * 0.04),
                      child: Image.asset(Assets.imagesDoctor)),
                  Transform.translate(
                      offset:
                          Offset(0, MediaQuery.of(context).size.height * 0.21),
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style:
                      TextStyles.regular10.copyWith(color: Color(0xff757575)),
                  textAlign: TextAlign.center,
                ),
              ),
              CustomButton(
