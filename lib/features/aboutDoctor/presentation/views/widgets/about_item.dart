    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Monday - Friday, ${_formatTime(doctorModel.startTime)}-${_formatTime(doctorModel.endTime)}',
            style:
                TextStyles.regular14.copyWith(color: const Color(0xff757575)),
          ),
          const SizedBox(
