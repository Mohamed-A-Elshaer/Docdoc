...
children: [
      ...
      text: TextSpan(
        ...
        children: [
          ...
          TextSpan(text: "Terms & Conditions ",
              style: TextStyles.medium12.copyWith(color: const Color(0xff242424)),
              recognizer: TapGestureRecognizer()
                ..onTap = () {},
          ),
          const TextSpan(text: "and "),
          TextSpan(text: "PrivacyPolicy.",style: TextStyles.medium12.copyWith(color: const Color(0xff242424)),
              recognizer: TapGestureRecognizer()
              ..onTap = () {},
          )
  ...
  RichText(
    textAlign: TextAlign.center,
    text: TextSpan(
        style: TextStyles.regular12.copyWith(color: const Color(0xff242424)),
        children: [
          TextSpan(text:text2),
          TextSpan(text:text3,
            style: TextStyles.semiBold12.copyWith(color: AppColors.primaryColor),
